...
// general images
  ...
  static String bag_image= "$bannersImagesPath/bag_image.png";
  ...
  static String hand_bag = "$categoriesImagesPath/hand_bag.png";
  static String shopping_bag = "$categoriesImagesPath/shopping_bag.png";
}
